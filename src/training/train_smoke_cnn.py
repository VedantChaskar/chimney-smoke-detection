"""
Custom CNN Smoke Classifier Training

Train custom CNN model for smoke classification.

Usage:
    python -m src.training.train_smoke_cnn
    python -m src.training.train_smoke_cnn --epochs 50 --batch-size 64
"""
...
def train_cnn_classifier(
    ...
    """
    Train Custom CNN for smoke classification
    ...
    """
    print("=" * 60)
    print("CUSTOM CNN SMOKE CLASSIFIER TRAINING")
    print("=" * 60)
    ...
    save_dir = save_dir or (SMOKE_EXPERIMENTS / 'cnn_training')
    ...
    print(f"✓ Best model saved to: {save_dir / 'best_cnn.pt'}")
    ...
    plot_path = OUTPUT_PLOTS_DIR / 'cnn_training_history.png'
    plot_training_history(history, plot_path)
    print(f"\n✓ Training plot saved to: {plot_path}")

    # Copy best model to models directory
    best_model_dest = SMOKE_MODELS_DIR / 'cnn_best.pt'
    best_model_src = save_dir / 'best_cnn.pt'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Train Custom CNN smoke classifier',
